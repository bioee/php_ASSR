...
// password_hash() permet de hasher le mot de passe, PASSWORD_DEFAULT est le dernier hashage recommandÃ© par la version php utilisÃ©
...
if (empty($login) OR empty($password) OR empty($mail)) {
    ...
    // on verifie que l'user n'existe pas déja
